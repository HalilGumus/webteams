...
#----------------------------------------------------------
   ...
   #-------------------------------------------------------
   def createList_px(self, data_opl, listform_spl):
   #-------------------------------------------------------
      if(listform_spl == "tabelle"):
         template_s = self.readFile_p('list.tpl.html')

      if(listform_spl == "aufzaehlung"):
         template_s = self.readFile_p('list2.tpl.html')
      template_o = Templite(template_s)
      markup_s = template_o.render(data_o = data_opl, listform = listform_spl)
      return markup_s
